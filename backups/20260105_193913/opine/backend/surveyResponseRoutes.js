...
} = require('../surveyResponseController');
...
// Stream audio file through server (proxy - eliminates cross-region charges)
// Must be before /:responseId route to avoid conflicts
router.get('/audio/*', streamAudioFile);

// Get signed URL for audio file (kept for backward compatibility)
