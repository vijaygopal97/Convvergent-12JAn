...
|-----------|---------------|------------|--------|--------------|------------------------|
| **Quality Agents** | 1,350 | 254 | 1,096 | **18.81%** ⚠️ | 5,586 |
| **CATI Interviewers** | 500 | 0 | 500 | **0.00%** ❌ | 30,060 |
| **CAPI Interviewers** | 5,300 | 5,300 | 0 | **100.00%** ✅ | 1,961 |
| **Project Managers** | 540 | 540 | 0 | **100.00%** ✅ | 4,856 |
| **Company Admins** | 120 | 120 | 0 | **100.00%** ✅ | 4,719 |
...
- **Connections:**
  ...
  - Maximum: 190
  - Minimum: 171
  - Status: ✅ Healthy (0.36% of 51,200 max)
...
1. **Fix Secondary Server Overload:**
   ...
   - Consider route-based load balancing (heavy ops → primary only)
